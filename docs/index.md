...
Every row is a package in the monorepo — no capability claimed here that isn't in the code, and the repo's own numbers (**1269 tests across 95 suites**) are checked against the live suite in CI (`pnpm counts:check`).
